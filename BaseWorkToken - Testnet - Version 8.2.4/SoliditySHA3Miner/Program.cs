        ...
        private static void Main(string[] args)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    var web3Interface = new NetworkInterface.Web3Interface(Config.web3api, Config.contractAddress, Config.minerAddress, Config.privateKey, Config.Difficulty_Multiplier, Config.chainID, WhatAddressToMineTo, Config.gasPrice,
                                                                          Config.abiFile, Config.networkUpdateInterval, Config.hashrateUpdateInterval,
                                                                          Config.gasLimit, Config.gasPricePriority, Config.gasApiURL, Config.gasApiPath, Config.gasApiMultiplier, Config.MaxBWORKperMint, Config.MinBWORKperMint, Config.HowManyBlocksAWAYFromAdjustmentToSendMinimumBWORK, Config.gasApiOffset, Config.gasApiMax, Config.mintToAddress);
