            ...
            try
            {
                ...
                else
                {
                    ...
                    var web3Interface = new NetworkInterface.Web3Interface(Config.web3api, Config.contractAddress, Config.minerAddress, Config.privateKey, Config.Difficulty_Multiplier, Config.chainID, WhatAddressToMineTo, Config.gasPrice,
                                                                          ...
                                                                          Config.gasLimit, Config.gasPricePriority, Config.gasApiURL, Config.gasApiPath, Config.gasApiMultiplier, Config.MaxBWORKperMint, Config.MinBWORKperMint, Config.HowManyBlocksAWAYFromAdjustmentToSendMinimumZKBTC, Config.gasApiOffset, Config.gasApiMax);
